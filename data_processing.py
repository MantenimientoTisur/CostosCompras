...
def process_data(df_ME5A, df_ZMM621_fechaAprobacion, df_IW38, df_ME2N_OC, df_ZMB52, df_MCBE, df_criticos, df_inmovilizados, df_tipos_cambio):
    ...
    column_order = [
        ...
        'TIPO COMPROMETIDO SUGERENCIA', ' Últ.mov.', 'Últ.cons.', 'Últ.salida','Costo compras por retirar','Dias Inmovilizados','Estado Inmovilizado','Val.stk.valor','Stock valorado','Material Critico?']
