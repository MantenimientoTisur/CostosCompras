...
if __name__ == "__main__":
    files = [
        "../Septiembre/ME5A SOLPEDS.xlsx",
        "../Septiembre/ZMM621 FECHA APROBACION.xlsx",
        "../Septiembre/IW38.xlsx",
        "../Septiembre/ME2N OC.xlsx",
        "../Septiembre/ZMB52 STOCK.xlsx",
        "../Septiembre/mcbe2023Septiembre.xlsx",
        "../Septiembre/CRITICOS.xlsx",
        "../Septiembre/INMOVILIZADO.xlsx",  
        "../Septiembre/Tasas de cambio.xlsx",
    ]
    main(files)