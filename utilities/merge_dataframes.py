   ...
   # Se inicia con un DataFrame base usando ciertas columnas de df_ME5A
    ...
    left_join_operations = [
        ...
        (df_ZMM621_OCompras, 'COMODIN OC',
         ['Estado factura', 'Fecha Doc. Fact.', 'Fecha de registro', 'Fecha contable',
        ...
        (df_inmovilizados_converted,'Material',['Dias Inmovilizados','Estado Inmovilizado','Val.stk.valor','Stock valorado'])
    ]
